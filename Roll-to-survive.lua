              ...
              while _G.AutoPotionActive do
                  ...
                  if root and humanoid then
                      ...
                      if orb then
                          ...
                          local targetCFrame = CFrame.new(orb.Position.X, orb.Position.Y - 14, orb.Position.Z) * CFrame.lookAt(Vector3.new(0,0,0), Vector3.new(lookDirection.X, 0, lookDirection.Z))
